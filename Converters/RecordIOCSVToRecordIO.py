...
with open(os.devnull, 'wb') as devnull:
    ...
    # python /Users/fcleary/PythonProjects/incubator-mxnet/tools/im2rec.py --pack-label outout /Users/fcleary/PythonProjects/AWS_ML/aws_ml_artifacts/Catan/CatanDicePhotos